...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    // 자동 변환
    int a  = 100;
    long b = a; // 자동으로 변환이 이루어지는 곳 (4byte -> 8byte)
    double c = b + 1.5; // 자동 변환이 이루어지는 곳  (b(long)를 double 타입으로 자동 변환하고 더하기를 한다.)
     ...
     * 1. int로 변환하기
     *    Integer.parseInt("1")     -> int타입 1 반환
     * 
     * 2. long으로 변환하기
     *    Long.parseLong("1")       -> long타입 1 반환
     * 
     * 3. double로 변환하기
