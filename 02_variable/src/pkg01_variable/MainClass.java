...
public class MainClass {
  ...
  public static void main(String[] args) {
     ...
     * 3. 변수도 메모리에 생성된다.
     * 4. 메모리는 1바이트(byte)마다 16진수로 된 고유의 번호를 부여해서 관리한다.
     *    1) 주소값
     *    2) 참조값       (으로 부름)
     *    3) 16진수 작성 예시 : 0x  ex)0x123abc456
     * 
     */
    
    /*
     * 식별자의 이름 규칙
     * 1. Pascal Case : 각 단어의 첫 글자는 대문자, 나머지는 소문자 (클래스 이름 규칙)
     * 2. Camel  Case : Pascal Case와 동일하지만, 첫 글자는 소문자로 작성(메소드 ,변수 이름 규칙)
     * 3. Snake  Case : 각 단어의 연결을 밑줄(_)로 하는 방식  (상수 이름규칙)
     */
    ...
    // float : 4바이트 실수
    float d = 1.1111111111111F;
    System.out.println(d);
    
    // double : 8바이트 실수
    double f = 1.1111111111111111111111;
     ...
     *  3. 참조자료형이지만 마치 기본 자료형처럼 쉬운 사용을 제공한다.
     */
    String s = "hello world";
    System.out.println(s);
    
    
    /* s에는 hello world의 참조값이 저장되어있음
     * ┌-------------┐
     * |  0x12345678 | s
     * |-------------|
     * |             |
