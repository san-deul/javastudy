...
public class Class01_String {
  ...
  public static void method2() {
    ...
    // String Literal : "문자열"
    // String Literal은 JVM이 관리한다. -> 동일한 Literal 은 재사용한다.
  ...
  public static void method6() {
    // chartAt : 지정한 인덱스(index)의 문자 반환..캐릭터의배열
    String str = "hello";
  ...
  public static void method7() {
    ...
    // indexOf     : 전달한 문자열이 발견된 첫 번째 인덱스를 반환, 없으면 -1 반환
  ...
  public static void method12() {
   ...
   // regular expression : 정규식..... , . : every character
