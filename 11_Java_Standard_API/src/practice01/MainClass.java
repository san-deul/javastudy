...
public class MainClass {
  ...
  public static Map<String, Object> method2(String id) {
    ...
    // 나이 구하기 + 성별 구하기
    // 나이 : 현재년도  - 태어난년도
    // 성별 : 하이픈 뒤의 숫자가 1이나 3이면 남, 2,4이면 여자
  ...
  public static void method4() {
    ...
    /*
    for(int balance = 5000; balance <= 0; balance--) {
      
      //Math.random()*5000
     // Math.random() * balance
     
      balance -= (int)(Math.random() * balance);
      //balance -= balance;
...
*/
  ...
  public static void method5() {
    ...
    String[] yuts = {"", "도", "개", "걸", "윷", "모"};
         //index     0    1      2    3     4      5            ※0은 더미요소...안쓸거야
    ...
    int totalMove = 0;
    do {
      move = (int)(Math.random() * 5 + 1); //윶 던지는 코드...
      totalMove += move;
      builder.append(yuts[move]); //던져서 나온거 builder에 저장함
      builder.append(", ");
      System.out.println(yuts[move]);
    } while(move >= 4 );//윷이나 모 나왔을시
    builder.append(totalMove).append("칸 이동한다.");
    
    //why do while? .. 일단 던져야되니까...
  ...
  public static void main(String[] args) {
    ...
    /*
    Map<String, Object> map = method2("940208-205435");
