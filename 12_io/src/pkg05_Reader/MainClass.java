...
public class MainClass {
  ...
  public static void method1() {
    ...
    try {
      ...
      // 읽는 단위
      char[] cbuf = new char[2]; // 몇글자읽을건지 결정
      ...
      while(true) {
        ...
        //cbuf 의 첫번째 글자 cbuf[0]부터 readChar갯수만큼 builder에 추가
      }
  ...
  public static void method2() {
    ...
    try {
      ...
      // readLine() 메소드는 파일 끝에 도달하면 null 반환
      /*
      while(true) {
        line = in.readLine(); // \n포함 안하고있음..줄바꿈 안되
        if(line == null) {
  ...
  public static void method3() {
    ...
    try {
      ...
      // BufferedReader 생성
      // 바이트 입력 스트림(FileInputStream) -> 문자입력스트림(InputStreamReader) -> 버퍼 입력 스트림(BufferedReader)
