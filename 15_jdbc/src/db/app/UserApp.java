...
public class UserApp {
  ...
  public static void main(String[] args) {
    ...
    */
     ...
     * 
     * 
     * List<UserDto> users = userService.getUsers(); for(UserDto user : users) {
     * System.out.println(user); }
     */
    
    
    //UserDto userDto =userDao.getUser(15);
...
*/    
   ...
   // System.out.println(result + "행이 삭젠되었습니다.");
