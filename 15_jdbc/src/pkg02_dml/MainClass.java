...
public class MainClass {
  ...
  public static void method1() {
    ...
    try {
      // oracle.jdbc.OracleDreiver 클래스 로드
      ...
      // PreparedStatement 객체 생성... connection이 만들어줄거임
  ...
  public static void method2() {
    ...
    try {
      ...
      // ------------준비끝↑, 쿼리↓
      //쿼리문 미리 만들시, 변수처리해야할 곳이 있으면 ? 로 처리한다      
      ...
      // 실행하기 전에 변수값 먼저 전달!!!!!!!
      //PreparedStatement는 무조건 쿼리문 먼저 준비! 근데 쿼리문에 변수처리할 부분이 있을테니,(이 부분은 ?), 이 변수처리할 부분 값은 나중에 채워줄거임
  ...
  public static void method4() {
    ...
    try {
      ...
      Scanner sc = new Scanner(System.in);
      System.out.println("삭제할 SAMPLE_NO 를 입력하세요 >>>");
